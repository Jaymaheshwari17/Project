...
<div class="row populor_category_grids mt-5">
    <div class="col-md-3 category_grid">
        <div class="view view-tenth">
            ...
            <div class="mask">
                <a href="#">
                    <img src="<?php echo $this->baseurl;?>/images/p1.jpg" class="img-fluid" alt="">
                </a>
            </div>
        </div>
    </div>
    <div class="col-md-3 category_grid">
        <div class="view view1 view-tenth">
            ...
            <div class="mask">
                <a href="#">
                    <img src="<?php echo $this->baseurl;?>/images/p2.jpg" class="img-fluid" alt="">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 category_grid">
        <div class="view view2 view-tenth">
            ...
            <div class="mask">
                <a href="#">
                    <img src="<?php echo $this->baseurl;?>/images/p3.jpg" class="img-fluid" alt="">
                </a>
            </div>
        </div>
    </div>
    <div class="col-md-3 category_grid">
        <div class="view view3 view-tenth">
            ...
            <div class="mask">
                <a href="#">
                    <img src="<?php echo $this->baseurl;?>/images/p4.jpg" class="img-fluid" alt="">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="tab-content" id="pills-tabContent">
            ...
            <div class="menu-grids mt-4">
                <div class="row t-in">
                    ...
                    <div class="col-lg-4 text-info-sec">
                        <img src="<?php echo $this->baseurl;?>/images/job-1.jpg" alt=" " class="img-fluid" />
                    </div>
        ...
        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            <div class="menu-grids mt-4">
                <div class="row t-in">
                    <div class="col-lg-4 text-info-sec">
                        <img src="<?php echo $this->baseurl;?>/images/job-2.jpg" alt=" " class="img-fluid" />
                    </div>
                    <div class="col-lg-8 text-info-sec">
                        <!--/job1-->
    ...
    <div class="parent-chart">
        <div class="level lev-one top-level">
            <div class="flow-position">
                <img src="<?php echo $this->baseurl;?>/images/s1.jpg" alt=" " class="img-fluid rounded-circle">
                <br>
        ...
        <div class="flow-chart">
            <div class="level lev-two last-lev">
                <div class="flow-position">
                    <img src="<?php echo $this->baseurl;?>/images/s2.jpg" alt=" " class="img-fluid rounded-circle">
                    <br>
            ...
            -->
                <div class="flow-position">
                    <img src="<?php echo $this->baseurl;?>/images/s3.jpg" alt=" " class="img-fluid rounded-circle">
                    <br>
            ...
            -->
                <div class="flow-position">
                    <img src="<?php echo $this->baseurl;?>/images/s4.jpg" alt=" " class="img-fluid rounded-circle">
                    <br>
            ...
            -->
                <div class="flow-position">
                    <img src="<?php echo $this->baseurl;?>/images/s5.jpg" alt=" " class="img-fluid rounded-circle">
                    <br>
            ...
            -->
                <div class="flow-position">
                    <img src="<?php echo $this->baseurl;?>/images/s6.jpg" alt=" " class="img-fluid rounded-circle">
                    <br>
            ...
            -->
                <div class="flow-position">
                    <img src="<?php echo $this->baseurl;?>/images/s7.jpg" alt=" " class="img-fluid rounded-circle">
                    <br>
            ...
            -->
                <div class="flow-position">
                    <img src="<?php echo $this->baseurl;?>/images/s8.jpg" alt=" " class="img-fluid rounded-circle">
                    <br>
...
<div class="row mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <div class="member-img">
                    <img src="<?php echo $this->baseurl;?>/images/team1.jpg" alt=" " class="img-fluid rounded-circle">
                </div>
    ...
    <div class="col-lg-3 member-main text-center">
        <div class="card">
            <div class="card-body">
                <div class="member-img">
                    <img src="<?php echo $this->baseurl;?>/images/team2.jpg" alt=" " class="img-fluid rounded-circle">
                </div>
                <div class="member-info text-center py-lg-4 py-2">
                    <h4>Janet Levine</h4>
    ...
    <div class="col-lg-3 member-main text-center">
        <div class="card">
            <div class="card-body">
                <div class="member-img">
                    <img src="<?php echo $this->baseurl;?>/images/team3.jpg" alt=" " class="img-fluid rounded-circle">
                </div>
                <div class="member-info text-center py-lg-4 py-2">
                    <h4>Rene Rickman</h4>
    ...
    <div class="col-lg-3 member-main text-center">
        <div class="card">
            <div class="card-body">
                <div class="member-img">
                    <img src="<?php echo $this->baseurl;?>/images/team4.jpg" alt=" " class="img-fluid rounded-circle">
                </div>
                <div class="member-info text-center py-lg-4 py-2">
...
<div class="row mt-5">
    ...
    <div class="card-deck">
        <div class="card">
            <img src="<?php echo $this->baseurl;?>/images/g1.jpg" alt="Card image cap" class="img-fluid card-img-top">
            <div class="card-body">
        ...
        <div class="card">
            <img src="<?php echo $this->baseurl;?>/images/g2.jpg" alt="Card image cap" class="img-fluid card-img-top">
            <div class="card-body">
        ...
        <div class="card">
            <img src="<?php echo $this->baseurl;?>/images/g3.jpg" alt="Card image cap" class="img-fluid card-img-top">
            <div class="card-body">
                <h5 class="card-title">Would Disruption Work for Your Business?</h5>
                <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut labore et dolore. </p>
            </div>
...
<div class="inner-sec-w3ls py-lg-5  py-3">
    <div class="row">
        ...
        <div class="col-md-5 app-img">
            <img src="<?php echo $this->baseurl;?>/images/mobile.png" alt=" " class="img-fluid">
        </div>
    </div>
    <!--//mobile-app -->
</div>
            ...
            <div class="row">
                <div class="col-md-6  testi-main">
                    <div class="testi-grids row">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-3 img-testi">
                            <img class="img-fluid" src="<?php echo $this->baseurl;?>/images/team4.jpg" alt="">
                        </div>
                ...
                <div class="col-md-6 testi-main">
                    <div class="testi-grids t2 row">
                        <div class="col-md-3 col-sm-3 col-xs-3 img-testi">
                            <img class="img-fluid" src="<?php echo $this->baseurl;?>/images/team3.jpg" alt="">
                        </div>
                        <div class="col-md-9 col-sm-9 col-xs-9 clients-info-text">
                            <h6>Cras rutrum</h6>
                ...
                <div class="col-md-6  testi-main">
                    <div class="testi-grids row">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-3 img-testi">
                            <img class="img-fluid" src="<?php echo $this->baseurl;?>/images/team2.jpg" alt="">
                        </div>
                ...
                <div class="col-md-6  testi-main">
                    <div class="testi-grids t2 row">
                        <div class="col-md-3 col-sm-3 col-xs-3 img-testi">
                            <img class="img-fluid" src="<?php echo $this->baseurl;?>/images/team1.jpg" alt="">
                        </div>
                        <div class="col-md-9 col-sm-9 col-xs-9 clients-info-text">
                            <h6>Cras rutrum</h6>
                            <p>Lorem ipsum dolor sit amet. enim, non convallis felis mattis.</p>
