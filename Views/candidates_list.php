...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="<?php echo $this->baseurl;?>/css/style6.css" rel='stylesheet' type='text/css' />
    <link href="<?php echo $this->baseurl;?>/css/style.css" rel='stylesheet' type='text/css' />
    <link href="<?php echo $this->baseurl;?>/css/fontawesome-all.css" rel="stylesheet">
                            ...
                            <ul class="navbar-nav ml-lg-auto text-center">
                                ...
                                <li class="nav-item dropdown active">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="services">Candidates</a>
                                        <a class="dropdown-item" href="candidates_list" title="">Candidates List 1</a>
                                        <a class="dropdown-item" href="candidates_list" title="">Candidates List 2</a>
                                        <a class="dropdown-item" href="candidates_list" title="">Candidates List 3</a>
                                        <a class="dropdown-item" href="candidates_single" title="">Candidates Single 1</a>
                    ...
                    <div class="col-lg-8 job_info_left">
                        ...
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                <div class="emply-img">
                                    <img src="<?php echo $this->baseurl;?>/images
/team1.jpg" alt="" class="img-fluid">
                                </div>
